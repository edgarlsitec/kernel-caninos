cmd_tools/common/image.o := cc -Wp,-MD,tools/common/.image.o.d -Itools -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -include /home/edgar/repo/kernel-caninos/uboot/include/libfdt_env.h -idirafterinclude -idirafter/home/edgar/repo/kernel-caninos/uboot/include -idirafter/home/edgar/repo/kernel-caninos/uboot/arch/arm/include   -I/home/edgar/repo/kernel-caninos/uboot/lib/libfdt   -I/home/edgar/repo/kernel-caninos/uboot/tools -DCONFIG_SYS_TEXT_BASE=0x08000040 -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE -c -o tools/common/image.o tools/common/image.c
...
deps_tools/common/image.o := \
  ...
  /home/edgar/repo/kernel-caninos/uboot/tools/../common/image.c \
