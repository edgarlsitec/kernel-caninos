cmd_arch/arm/cpu/armv7/owl/pinctrl.o := arm-linux-gnueabihf-gcc -Wp,-MD,arch/arm/cpu/armv7/owl/.pinctrl.o.d  -nostdinc -isystem /usr/lib/gcc-cross/arm-linux-gnueabihf/6/include -Iinclude  -I/home/edgar/kernel-caninos/uboot/include -I/home/edgar/kernel-caninos/uboot/arch/arm/include -include /home/edgar/kernel-caninos/uboot/include/linux/kconfig.h  -I/home/edgar/kernel-caninos/uboot/arch/arm/cpu/armv7/owl -Iarch/arm/cpu/armv7/owl -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x08000040 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(pinctrl)"  -D"KBUILD_MODNAME=KBUILD_STR(pinctrl)" -c -o arch/arm/cpu/armv7/owl/pinctrl.o /home/edgar/kernel-caninos/uboot/arch/arm/cpu/armv7/owl/pinctrl.c

source_arch/arm/cpu/armv7/owl/pinctrl.o := /home/edgar/kernel-caninos/uboot/arch/arm/cpu/armv7/owl/pinctrl.c

deps_arch/arm/cpu/armv7/owl/pinctrl.o := \
    $(wildcard include/config/atm7059a.h) \
    $(wildcard include/config/atm7059tc.h) \
    $(wildcard include/config/atm7039c.h) \
...
arch/arm/cpu/armv7/owl/pinctrl.o: $(deps_arch/arm/cpu/armv7/owl/pinctrl.o)
